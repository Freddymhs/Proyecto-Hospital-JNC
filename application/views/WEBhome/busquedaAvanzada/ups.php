...
<div class="card align-content-center align-items-center align-middle align-self-center">
	<table id="example" class="align-self-center table  table-bordered table-responsive" cellspacing="0" style="width:100%">
		...
		<thead class="bg bg-primary text-white">
			<tr>
				...
				<th class="bg bg-secondary">Capacidad</th>
				<th class="bg bg-secondary">Funcionalidades</th>
				<th class="bg bg-secondary">Durabilidad</th>
