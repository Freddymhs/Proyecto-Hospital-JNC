...
<div class="row"> 
	...
	<div class="col-3">
		<label class="col-form-label"  for="xUsuario">Monitor</label>
	...
	<div class="col-4">
		...
		<div class="col-2">
			<label class="col-form-label"  for="htr">Serial</label>
		</div>
		<div class="col-3">
			<div class="input-group mb-3 input-group">
				<input type="text" class="form-control" name="txtserialmonitor" id="txtserialmonitor" value="<?php echo set_value('txtserialmonitor'); ?>"  >
			</div>
			<div class="input-group mb-3 input-group">
	...
	<div class="col-12">
		...
		<div class="collapse border border-white" id="collapMonitor">
			<div class="card card-header bg-primary text-white">
				<p class="align-self-center" style="font-size: 15px;"><b>Crear un nuevo Modelo de Monitor</b></p>
			</div>
				...
				<div class="row">
					...
					<div class="col-4">
						<div class="input-group mb-3 input-group">
							...
							<input type="text"  name="collapModMon" id="collapModMon" class="form-control" autocomplete="on" onfocusout="cleanMonitSelected()" value="<?php echo set_value('collapModMon'); ?>">
						</div>
						<div class="input-group mb-3 input-group" > 
