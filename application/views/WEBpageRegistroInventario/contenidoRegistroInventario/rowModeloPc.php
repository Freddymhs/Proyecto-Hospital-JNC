<div class="row"> 
	<div class="col-3">
		<label class="col-form-label"  for="xUsuario">Modelo PC</label>
	</div>
	<div class="col-4">
		...
		<div class="col-3">
			<div class="input-group mb-3 input-group">
				<input type="text" class="form-control" placeholder="wmic bios get serialnumber" name="txtserialpc" ID="txtserialpc"  value="<?php echo set_value('txtserialpc'); ?>"  >
			</div>
			<div class="input-group mb-3 input-group">
	...
	<div class="col-12">
		...
		<div class="collapse border border-white" id="collapPC">
			<div class="card card-header bg-primary text-white">
				<p class="align-self-center" style="font-size: 15px;"><b>Crear un nuevo Modelo de Computador</b></p>
			</div>
