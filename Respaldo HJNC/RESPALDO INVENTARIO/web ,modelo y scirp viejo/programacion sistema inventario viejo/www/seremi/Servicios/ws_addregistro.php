...
//$ut = new Utiles();
//$ut->addlog("../servicios/msj_addregistro.log","$num_ficha_hosp,$num_ficha,$fecha_creada,$rut,$nombres,$fecha_nac,$apellidos,$edad,$direccion,$profesion,$procedencia,$escolaridad,$estado_civil,$mac,$genero,$transfusiones,$sexo,$alergia,$donante,$observaciones \n");

$res = $ficha->add_registro($num_ficha,$num_ficha_hosp,$fecha_creada,$rut,$nombres,$fecha_nac,$apellidos,$edad,$direccion,$profesion,$procedencia,$escolaridad,$estado_civil,$mac,$genero,$transfusiones,$sexo,$alergia,$donante,$observaciones);

header('Content-Type: text/xml');

if ($res) {
	$ret="1"; 
	$msj="Grabacion Existosa  (ws_addregistro)";
} else {
	$ret="0";
	$msj="ERROR:  (ws_addregistro)";
}
