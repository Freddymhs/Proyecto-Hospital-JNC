...
onload=function()
{
	...
	form=document.getElementById("formularioUpd");
	urlDestino="mail.php";
...
function validaForm()
{
	...
	var id_ficha=eliminaEspacios(form.id_ficha.value);
	...
	else
	{
		...
		ajax.onreadystatechange=function()
		{
			if (ajax.readyState==4)
			{
				...
				if(campo=="1")
				{
					var texto="<img src='imagenes/Good.png' alt='Ok'><br>Registro actualizado con exito<br>";
				}
				else var texto="<img src='imagenes/Error.png'><br><br>Error: Un campo fue llenado mal<br><br><button style='width:80px; height:20px; font-size:10px;' onClick='ocultaMensajeError()' type='button'>Ok</button>";
