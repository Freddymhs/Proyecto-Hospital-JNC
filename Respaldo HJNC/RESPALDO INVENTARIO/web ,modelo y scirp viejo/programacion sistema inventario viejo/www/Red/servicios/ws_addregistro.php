...
$res = $inv->add_inventario($id_unidad,$red,$ip,$mac,$net,$grupo,$usuario,$impresora,$telefono,$serie_pc,$serie_monitor,$modelo_pc,$modelo_mon,$procesador,$disco_duro,$ram);
...
if ($res) {
	$ret="1"; 
	$msj="Grabacion Existosa  (ws_addinventario)";
} else {
	$ret="0";
	$msj="ERROR:  (ws_addinventario)";
}
