...
<body class="body" onfocus="enviaQueryUnidad('unidad','servicios/ws_getunidad.php')">
 <div id="formContenedorbuscar">
   <div id="divcompleto">
    <form id="" action="formulario_busqueda.php" method="get">
              ...
              <?
				...
				for ($i=0; $i < sizeof($res); $i++){
					...
					echo"<tr onclick='ilumina(this)' id='celda1' name='celda1'>";
						echo"<td class='td'><a href='formulario_update.php?id=$id' rel='gb_page_center[822, 650]'>".$res[$i]['id_inventario']."</a></td>";
